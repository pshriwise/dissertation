...
traversal by ensuring that the number primitives are split as evenly as possible from
...
set both an upper and lower bound as both an unacceptably high and ``good enough''
cost, respectively.
