...
utilization model and simulation results can be found in Appendix
\ref{ch:appendix-c}. The results of these tests indicate that the utilization
model can be used to predict the data structure's utilization for other
geometries as well, though with some limitations.
...
which the utilization model can be applied in an arbitrary geometry. While
...
comparison to those demonstrated in Section \ref{subsec:utilization_model} for
the hydrogen-filled sphere tests.
