...
Ideally, this method will only be applied to volumes in which the preconditioning 
method is able to avoid ray fire calls often or with high utilization
...
through the geometry (see Table . As such, this type of query is the focus of utilization
