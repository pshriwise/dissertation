...
sealed (or topologically watertight) models, the physics event mode is likely to
provide a performance enhancement equal to or better than that of the SDF
preconditioning method. For models which are unable to be sealed fully, it may
be useful to consider application of the SDF preconditioner instead,
particularly if a majority of particle interactions are occurring in an unsealed
region of the model.
