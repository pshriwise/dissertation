...
such as a Cartesian grid or an Octree. Associated with each vertex in the mesh
is a signed value representing the distance to the nearest surface of the
geometry. Signed distance values can be constructed for arbitrary locations
...
\begin{sidewaysfigure}[H]
  ...
  \caption{Depiction of utilization model limitation due to a small local average chord length
    in the region of high collision density.}
