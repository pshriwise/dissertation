...
\begin{table}[H]
  ...
  \makebox[\textwidth][c]{
    \begin{tabular}{l c c c c c}
      \toprule
      \textbf{Model} & \textbf{Particle Types}                  & \textbf{Total Geometry Queries} & \textbf{Next Surface} & \textbf{Closest Surface} & \textbf{Point in Volume} \\
      \hline
      SNS            & $\alpha$,p,$\gamma$,$\beta$,$^{3}H$,n... & 52576465                        & 99.1\%                & < 0.1\%                  & 0.8\%                    \\
      nTOF           & p,$\gamma$,n                             & 62553081                        & 99.4\%                & 0.5\%                    & 0.1\%                    \\
      ITER           & n                                        & 4001570110                      & < 0.1\%               & 0 \%                     & 99.99\%                  \\      
      SHINE          & n                                        & 81275652                        & 99.9\%                & 0\%                      & < 0.1\%                  \\
      \bottomrule
    \end{tabular}
  }
