...
\textit{measure\_volume} and \textit{measure\_area} for each cell in question. The mesh step
...
This script was applied to several production models to identify volumes sutable
for application of the SDF.
