...
using this mode in comparison to the similar implicit tracking method employed
...
\begin{table}[H]
  ...
  \begin{tabular}{c c c c c}
    \toprule
    \textbf{\thead{Model}} & \textbf{\thead{Performance \\ Ratio}} & \textbf{\thead{Fully Sealed \\ Model}} & \textbf{\thead{Matching \\ Results}} & \textbf{\thead{No Lost \\ Particles}} \\
    \hline
    ...
    \bottomrule
  \end{tabular}
  \caption[SDF production simulation times using DAGMC's physics distance
    optimization.]{Results from limiting ray lengths in DAGMC using the distance
    to the next physics event. Performance ratios are measured as finite ray
    lengths vs. infinite ray lengths. Matching numerical results, topological
