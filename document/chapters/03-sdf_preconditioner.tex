...
subroutines. Despite these factors diminishing the effects of the data
structure, a volume in the medical isotope production model from SHINE (shown in
Figure \ref{fig:shine_sdf}) was determined to be a suitable candidate for SDF
application.
...
\begin{tabular}{c c c}
  \hline
  Implementation & Runtime (min) & Timing Ratio \\
  \hline
  DAG-MCNP & 76.14 & 1.00 \\
