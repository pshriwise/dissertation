...
for the relatively expensive ray fire process to accelerate CAD-based MCRT by
using an $O(1)$ process by establishing that the conditions of a geometric query
