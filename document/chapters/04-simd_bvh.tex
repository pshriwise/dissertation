...
contributing slightly to the tally in cell 3. This difference is caused by a
difference in ray fire convention between MOAB and Embree rather than being
result of the double to single floating point conversion of the model that
occurs when using EmDAG. Ray-triangle intersection results for rays with origins
numerically on a triangle are considered intersecting in MOAB but not in Embree.
