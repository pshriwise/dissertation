...
versions of DAG-MCNP were the same \DIFdelbegin \DIFdel{with the exception of the ITER test
...
particle tracking }\DIFdelend \DIFaddbegin \DIFadd{for all production models presented in Table
\ref{tab:mpbvh_transport_timing_production}. It is worth noting, however, that
the simplified }\DIFaddend algorithm presented in Section
\ref{sec:simplified_particle_tracking} \DIFdelbegin \DIFdel{. The discrepancies between the DAG-MCNP
implementations are outlined in Appendix \ref{ch:appendix-b}}\DIFdelend \DIFaddbegin \DIFadd{was unable to accurately track particles
...
instead to obtain the same numerical result}\DIFaddend .
