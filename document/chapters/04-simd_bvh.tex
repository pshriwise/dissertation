...
\begin{lstlisting}[language=Python,basicstyle=\tiny,caption={The method used for \textit{Next Surface} queries.},captionpos=b,label={alg:Next Surface Pseudo Code}]
...
\begin{lstlisting}[language=Python,basicstyle=\tiny,caption={Algoritm for determining point containment within a volume.},
...
\begin{table}[H]
  ...
  \begin{center}
    \begin{tabular}{lccc}
      ...
      ITER-BLITE    & N/A  / N/A  &  116   / N/A   & 44   / N/A  \\
      \bottomrule
    \end{tabular}
  \end{center}
  \caption{Runtime comparison native MCNP, DAG-MCNP, and DAG-MCNP using the
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{lcc}
      ...
      \toprule
      Test Model & DAG-MCNP & DAG-MCNP MPBVH \\
      %%\hline
      & \multicolumn{2}{c}{\textbf{Memory Usage (MB)}} \\
      \hline
      FNG           & 198  & 164 \\
      ATR           & 324  & 260 \\
      UWNR          & 217  & 168 \\
      ITER-BLITE    & 4,994  & 3,749  \\
      \bottomrule
    \end{tabular}
  \end{center}
