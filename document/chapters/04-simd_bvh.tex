...
through its BVH contributes greatly to its speed. This can be also considered a
...
with performance comparable to Embree's.
...
to access the database's memory directly to about duplication of information in
