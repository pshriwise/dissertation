...
Section \ref{sec:node_encoding}), he surface root node reference is identified
...
on the ray. The node is then pushed onto the stack and the traversal continues
