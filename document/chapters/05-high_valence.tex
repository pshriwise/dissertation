...
as simulation. These statistics lend some insight into the impact of HV regions
on DAGMC simulation performance based on
...
\begin{table}
  ...
  \begin{tabular}{lcccc}
    \toprule
    Test Model & \thead{Regions \\ Identified} & \thead{Average Area
      \\ ($cm^{2}$)} & \thead{Average \\  Valence} & \thead{HV Leaf \\ Visit Frequency} \\
    \hline
    FNG        & 514                & 12.91                   & 179.9           & 3.83\%          \\
    ATR        & 836                & 3.98                    & 43.38           & 0.07\%          \\ 
    UWNR       & 499                & 2855.2                  & 31.63           & 3.87\%          \\
    ITER       & 3522               & 1363.4                  & 93.3            & 7.34\%          \\
    \bottomrule
  \end{tabular}
