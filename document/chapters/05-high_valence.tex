...
\begin{figure}[H]
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[scale=0.2]{fng_facet_tol.png}
    \caption{Faceting Tolerance Only}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \centering
    \includegraphics[scale=0.2]{fng_len_tol.png}
...
\begin{table}[H]
  ...
  \begin{tabular}{c c c c c c}
    ...
    \hline
    FNG  & 1.17  &  1.76  & 291 & 463  & 1.32 \\
    ATR  & 4.95  & 30.00 & 1034 & 5099 & 1.01 \\
    UWNR & 3.34  & 10.10 & 639 & 1770 & 0.83 \\
    ITER & 39.63 & 42.39 & & 5352 & 1.31 \\
    \bottomrule
  \end{tabular}
...
statistically similar in all corresponding simulations. As seen in the BVH
refinement study, the greatest effect was seen in the FNG and ITER simulations
where the run times were reduced by $\approx30\%$. In contrast, the UWNR
simulation became almost $20\%$ worse. This is likely caused by the dramatic
increase in the number of triangles for this model which could be mitigated by
increasing the specified length tolerance. It is difficult to know a priori what
faceting tolerance is optimal when tessellating models, but this study shows
that an alternative meshing scheme may be another solution to mitigating the
effect of HV regions on simulation performance.
