...
model is used as a production demonstration of the effect of high valence
...
From what is known about the construction of MOAB's OBB-BVH, it was expected that
...
\begin{table}[H]
  ...
  \begin{tabular}{c c c c c}
    \toprule
    \textbf{\thead{Model}} & \textbf{\thead{HV \\ regions}} & \textbf{\thead{Particle \\ histories}} & \textbf{\thead{Runtime \\ reduction}} & \textbf{\thead{Buildtime \\ increase}} \\
    \hline
    FNG            & 514                 & 1M                          & 3.3\%                      & 18.5\%                      \\
