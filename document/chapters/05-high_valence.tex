...
\begin{figure}[H]
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{hv_study_moab_small_v.eps}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{hv_study_moab_adaptive_small_v.eps}
  \end{subfigure}
...
\begin{figure}[H]
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{hv_study_simd_small_v.eps}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.5\textwidth}
    \includegraphics[width=\linewidth]{hv_study_simd_adaptive_small_v.eps}
  \end{subfigure}
...
\begin{sidewaystable}[p]
  ...
  \begin{tabular}{c c c c c c}
    \toprule
    \textbf{\thead{Model}} & \multicolumn{2}{c}{\textbf{\thead{Triangles (M)}}} & \multicolumn{2}{c}{\textbf{\thead{Memory Usage (MB)}}} & \textbf{\thead{Timing Ratio \\ (Faceting Tol. / \\ Faceting \& Length Tol.)}} \\
    &  \thead{Faceting \\ Tolerance} & \thead{Faceting \& \\ Length Tolerance} & \thead{Faceting \\ Tolerance} & \thead{Faceting \& \\ Length Tolerance} & \\
    \hline
