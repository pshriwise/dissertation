...
counter was incremented each time one of these tagged nodes was visited in the
simulation, along with counters for the number of total nodes visited and the
number of general leaf nodes visited. Additionally, the number of HV leaf nodes
was tracked along with the valence and area of each HV region. Average values
for these HV regions are shown to provide a sense of the severity of these
