...
otherwise. \DIFaddbegin \DIFadd{A sweep of the high valence parameter, $\alpha$, for these models is
...
\begin{figure}[H]
  ...
  \caption[High valence detection parameter study.]{\DIFaddFL{Variation in run time for
...
\DIFdelend \DIFaddbegin \caption[HV characterization studies using EmDAG and MPBVH.]{\DIFaddend HV characterization results for all SIMD-enabled ray tracing
...
these simulations can be found in Figure \DIFdelbegin \DIFdel{\ref{fig:hv_parameter_study_simd}}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:hv_parameter_study_mpbvh}}\DIFaddend .

\begin{figure}[H]
  \centering
  \DIFdelbeginFL %DIFDELCMD < \includesvg{../images/hv_parameter_study_simd}{width=1.0\textwidth}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includesvg{../images/hv_parameter_study_mpbvh}{width=1.0\textwidth}
  \DIFaddendFL \caption[High valence detection parameter study.]{Variation in run time for
    different HV detection parameters on a representative set of DAGMC models
    \DIFaddbeginFL \DIFaddFL{using the MPBVH}\DIFaddendFL .}
  \DIFdelbeginFL %DIFDELCMD < \label{fig:hv_parameter_study_simd}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:hv_parameter_study_mpbvh}
...
reduced by up to \DIFdelbegin \DIFdel{nearly 30}\DIFdelend \DIFaddbegin \DIFadd{~40}\DIFaddend \% with little additional build times in the BVH and
