...
\subsection{Simple Test Cases}
  ...
  \begin{table}[H]
    ...
    \begin{center}
      \begin{tabular}{lccc}
        ...
        \bottomrule
      \end{tabular}
      \caption{Single hydrogen-filled cube tally results. Flux tally units are
  ...
  \begin{table}[H]
    ...
    \begin{center}
      ...
      \end{tabular}
      \caption{Nested hydrogen-filled cube tally results. Flux tally units are
        $cm^{-2}$. Energy tally units are MeV/g.}
      \label{nestedspheres}
    \end{center}
    %%\vspace{-0.2cm}
  ...
  \begin{table}[H]
    ...
    \begin{center}
      \begin{tabular}{lccc}
        ...
        \bottomrule
      \end{tabular}
      \caption{Single hydrogen-filled sphere tally results. Flux tally units are
        $cm^{-2}$. Energy tally units are MeV/g.}
      \label{nestedspheres}
    \end{center}
    %%\vspace{-0.2cm}
  ...
  \begin{table}[H]
    ...
    \begin{center}
      ...
      \end{tabular}
    \end{center}
    \caption{Summary of the flux tally results for a global volumetric source in the FNG model for MCNP, DAG-MCNP, and Embree coupled with DAGMC, or EmDAG-MCNP.}
  \end{table}
...
\subsubsection{FNG}
  ...
  \begin{table}[H]
    ...
    \begin{center}
      ...
      \end{tabular}
    \end{center}
    \caption{Summary of the flux tally results for a global volumetric source in the FNG model for MCNP, DAG-MCNP, and DAG-MCNP using the MPBVH.}
  \end{table}
  ...
  \begin{table}
    ...
    \begin{center}
      ...
      \end{tabular}
    \end{center}
    \caption{Results of an eigenvalue simulation for the Advanced Test Reactor at Idaho National Laboratory over 100 cycles.}
  \end{table}
  ...
  \begin{table}
    ...
    \begin{center}
      ...
      \end{tabular}
    \end{center}
    \caption{Results of an eigenvalue simulation for the University of Wisconsin
      Nuclear Reactor over 75 cycles.}
  \end{table}
...
\begin{table}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Result comparison for a mesh-based flux tally applied to the ITER
    neutronics model for \num{1E7} histories.}
\end{table}
...
\begin{table}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{A result comparison between DAG-MCNP with and without the SDF field
    applied for 10K histories in the the neutron Time-Of-Flight model.}
\end{table}
...
\begin{table}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{A result comparison for the SHINE model with and without SDF
    application for 10k particle histories.}
\end{table}
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{lcc}
      ...
      \bottomrule
    \end{tabular}
    \caption{Result comparison for a variety of atom displacement tallies in
      the Spallation Neutron Source model in DAG-MCNP both with and without the
      SDF for 10K histories.}
  \end{center}
\end{table}
