...
such as MCAM \cite{Liu_2005} and McCad \cite{Tsigetamirat_2008} allow for interactive visualization and repair of CSG
models they do not provide the accuracy of CAD modeling engines.
...
CAD models. DAGMC relies on Cubit and its commercial version, Trelis, for CAD
modeling. Both of these CAD packages rely on ACIS.
