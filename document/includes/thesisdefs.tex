...
\gdef\@department{(Nuclear Engineering \& Engineering Physics)} % Default is Electical Engineering
\gdef\@defensedate{06/08/2018}% Default is a long time from now.
\gdef\@committee{
...
\gdef\@advisorname{Paul P.H. Wilson}
